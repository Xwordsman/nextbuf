...
- Current completed milestone: `v0.11.0`; develop only `v0.12.0` next.
...
- `v0.12.0` is the only next milestone; implement production packaging and deployment without adding plugins, commerce or unrelated product features early.
