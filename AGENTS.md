...
- Current completed milestone: `v0.7.0`; develop only `v0.8.0` next.
...
- `v0.8.0` adds likes, bookmarks, follows, reading state, anti-abuse view counts, PostgreSQL search and content discovery. Do not implement notifications, governance workflows, admin pages or trust calculations early.
