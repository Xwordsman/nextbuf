...
- Current completed milestone: `v0.12.0`; develop only `v0.13.0` next.
...
- `v0.13.0` is the only next milestone; harden security, performance, migration, recovery and accessibility without adding plugins, commerce or unrelated product features early.
