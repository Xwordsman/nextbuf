...
- Current completed milestone: `v0.9.0`; develop only `v0.10.0` next.
...
- Notifications, preferences, notification email delivery, scheduling and Worker operations follow ADR-0012. `v0.10.0` is the only next milestone; do not implement plugins, commerce or unrelated admin CRUD early.
