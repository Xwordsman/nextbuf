...
本文定义 NextBuf 开发环境的实际命令和工作流。`v0.7.0` 已实现 PostgreSQL、Redis、Mailpit、Better Auth、SMTP/附件 Worker、真实身份/资料/社区集成测试、同时运行 standalone Web 与 Worker 的 Playwright E2E、本地/S3 存储，以及真实节点、主题、回复、Markdown 和附件链路。
...
`v0.7.0` E2E 依赖 PostgreSQL、Redis、Mailpit、Web 和 Worker，覆盖：
...
- 真实社区首页、节点路由、主题搜索过滤、Markdown 预览、附件上传、发布/编辑主题、回复、提及、引用、编辑回复、软删除/恢复和“我的主题”。
