...
> 当前阶段：`v0.3.0` 页面框架已完成，下一阶段为 `v0.4.0` 身份认证。`UI/index.html` 仅是历史视觉参考，运行页面以 `src/app` 和 `src/components` 为准。
...
当前没有 Next.js 应用代码、Dockerfile 或可运行 Compose。文档中标注为目标合同的命令必须在对应版本实现后才能使用。
